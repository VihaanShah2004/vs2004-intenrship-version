...
class PopupManager {
    ...
    analyzeWebsite(url, title) {
        // Simplified analysis for demo purposes only
        const domain = 'demo-site.com';
        const titleLower = title.toLowerCase();
        
        // Basic category detection based on common keywords
        const categories = {
            'dining': ['restaurant', 'food', 'dining', 'eat', 'menu', 'order', 'delivery', 'pizza', 'burger', 'cafe', 'coffee'],
            'groceries': ['grocery', 'supermarket', 'food', 'fresh', 'organic', 'produce', 'meat', 'dairy', 'pantry'],
            'travel': ['hotel', 'flight', 'airline', 'travel', 'booking', 'vacation', 'trip', 'resort'],
            'gas': ['gas', 'fuel', 'station'],
            'shopping': ['shop', 'store', 'buy', 'purchase', 'cart', 'checkout', 'retail'],
            'entertainment': ['movie', 'streaming', 'entertainment', 'game', 'music'],
            'utilities': ['electric', 'water', 'internet', 'phone', 'cable', 'utility', 'bill', 'payment']
        };
