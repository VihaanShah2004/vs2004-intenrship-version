    ...
    initializeCreditCards() {
        ...
        const creditCards = {
            ...
            "apple_card": {
                ...
                "categories": ["tech", "apple", "general"],
                "features": {
                    "foreignTransactionFee": 0,
                    "balanceTransferFee": 0,
                    "cashAdvanceFee": 0,
                    "latePaymentFee": 0,
                    "aprRange": "15.99-26.99"
                }
            },
            "amazon_prime_card": {
                "id": "amazon_prime_card",
                ...
                "categories": ["shopping", "amazon", "restaurants", "gas"],
                "features": {
                    "foreignTransactionFee": 0,
                    "balanceTransferFee": 0.05,
                    "cashAdvanceFee": 0.05,
                    "latePaymentFee": 40,
                    "aprRange": "19.24-27.24"
                }
            },
            "target_redcard": {
                "id": "target_redcard",
                ...
                "type": "Store Card",
                "annualFee": 0,
                "creditScoreRequired": "Fair to Good",
                "creditLimitRange": {
                    "min": 1000,
                    "max": 15000,
                    "typical": 5000
                ...
                "categories": ["shopping", "target", "retail"],
                "features": {
                    "foreignTransactionFee": 0.03,
                    "balanceTransferFee": 0.05,
                    "cashAdvanceFee": 0.05,
                    "latePaymentFee": 40,
                    "aprRange": "22.90-29.99"
                }
            },
            "costco_citi": {
                "id": "costco_citi",
                ...
                "categories": ["wholesale", "gas", "restaurants", "travel"],
                "features": {
                    "foreignTransactionFee": 0,
                    "balanceTransferFee": 0.05,
                    "cashAdvanceFee": 0.05,
